  ...
  <div class="row border">
      ...
      <div class="col-8 my-2 ms-4 w-auto">
          <ul class="list-unstyled m-0">
              <li class="ml-2"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                      class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                  Qualité de la prestation</li>
              <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                      class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i> Professionnalisme du prestataire
              </li>
              <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                      class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i> Rapport qualité/prix</li>
              <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                      class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i> Temps de réponse</li>
          </ul>
      </div>
  </div>
  ...
  <div class="row">
      <div class="row">
          ...
          <div class="col-4 pt-3 p-0">
              ...
              <ul class="list-unstyled m-0">
                  <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
          ...
          <div class="col-6 border-end m-0 p-0">
              <ul class="list-unstyled m-0 p-0">
                  ...
                  <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i> Professionnalisme du prestataire
                  </li>
              </ul>
          </div>
          ...
          <div class="col-6 m-0 p-0 ps-3">
              <ul class="list-unstyled m-0 p-0">
                  <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i> Rapport qualité/prix</li>
                  <li><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i> Temps de réponse</li>
              </ul>
          </div>

          <p class="card-text mt-2 mb-2">Lieu magnifique pour tout évènement.<br>
              Les propriétaires sont très disponibles et agréables.</p>
