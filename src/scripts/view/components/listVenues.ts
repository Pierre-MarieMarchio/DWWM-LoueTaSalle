      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex align-items-center">
          ...
          <div class="px-3">
            ...
            <p>
              Mariages, anniversaires, baptêmes... Notre domaine à Agde offre
              une salle idéale pour accueillir votre événement, avec une
              attention particulière portée aux repas et ...
            </p>
            <div class="row">
              <div class="col">
                <i class="fa-solid fa-user"></i><span> 40-400</span>
              </div>
              <div class="col">
                <i class="fa-solid fa-bed"></i> <span> 59 max</span>
              </div>
              <div class="col"><i class="fa-solid fa-utensils"></i></div>
            </div>
            <div class="py-3">
              <i class="fa-solid fa-euro-sign"></i
              ><span>Forfait dès 89 € / pers.</span>
            </div>
