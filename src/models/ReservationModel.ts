...
export default class BookingModel {
  ...
  private checkLastName(): string {
    if (typeof this._formdata.lastName === "string") {
      if (
        ...
        throw new Error(
          "Le nom de famille est soit trop court, soit trop long."
        );
      }
    } else {
  ...
  private checkEventType(): string {
    if (
      typeof this._formdata.eventType === "string" &&
      this._formdata.eventType !== ""
    ) {
  ...
  private checkEventCaterer(): string {
    if (
      typeof this._formdata.eventCaterer === "string" &&
      this._formdata.eventCaterer !== ""
    ) {
  ...
  private checkEventQuotation(): string {
    if (
      typeof this._formdata.eventQuotation === "string" &&
      this._formdata.eventQuotation !== ""
    ) {
  ...
  private checkEventAccomodation(): string {
    if (
      typeof this._formdata.eventAccomodation === "string" &&
      this._formdata.eventAccomodation !== ""
    ) {
  ...
  private checkEventDetails(): string {
    if (
      typeof this._formdata.eventDetails === "string" &&
      this._formdata.eventDetails !== ""
    ) {
  ...
  private checkCguCheck(): boolean {
    if (
      typeof this._formdata.cguChecked === "boolean" &&
      this._formdata.cguChecked === true
    ) {
